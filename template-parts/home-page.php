...
<!-- <?php get_template_part('/component/vistor', 'header'); ?> -->
        ...
        <div class="container">
            <div class="watcher-desktop-nav">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="logged-out-menu text-center">
                        <li>
                            <a href="http://localhost:81/watcher/login/">Login</a>
                        </li>
                        <li>
                            <a href="http://localhost:81/watcher/sign-up/">Sign Up</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="watcher-mobile-nav">
            <div class="container">
                <div class="row d-flex justify-content-between align-items-center">
                    <div class="sidenav" style="top: 88px;">
